    ...
    <svg class="lds-spin" :class="size" :width="height" :height="height"
        ...
        <g transform="translate(80,50)">
            <g transform="rotate(0)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="1" :transform="transforms[0]">
        ...
        <g transform="translate(71.21320343559643,71.21320343559643)">
            <g transform="rotate(45)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="0.875" :transform="transforms[1]">
        ...
        <g transform="translate(50,80)">
            <g transform="rotate(90)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="0.75" :transform="transforms[2]">
        ...
        <g transform="translate(28.786796564403577,71.21320343559643)">
            <g transform="rotate(135)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="0.625" :transform="transforms[3]">
        ...
        <g transform="translate(20,50.00000000000001)">
            <g transform="rotate(180)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="0.5" :transform="transforms[4]">
        ...
        <g transform="translate(28.78679656440357,28.786796564403577)">
            <g transform="rotate(225)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="0.375" :transform="transforms[5]">
        ...
        <g transform="translate(49.99999999999999,20)">
            <g transform="rotate(270)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="0.25" :transform="transforms[6]">
        ...
        <g transform="translate(71.21320343559643,28.78679656440357)">
            <g transform="rotate(315)">
                <circle cx="0" cy="0" r="7" fill="#e31837" fill-opacity="0.125" :transform="transforms[7]">
