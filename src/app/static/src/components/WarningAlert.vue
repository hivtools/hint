<template>
    <div v-if="showAlert">
        <div class="content alert alert-warning alert-dismissable pt-0">
            <button @click="$emit('clear-warnings')"
                    type="button"
                    data-bs-dismiss="alert"
                    class="btn-close mt-2 float-end"
                    v-translate:aria-label="'close'">
            </button>
