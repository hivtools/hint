<template>
    <div class="mt-2 mb-4">
        <div class="custom-file">
            ...
            <label :for="name"
                   class="custom-file-label d-flex justify-content-between align-items-center file-input-box"
                   :class="{'uploading': uploading}">
                <span class="px-3 file-input-text" v-translate="'selectNewFile'"></span>
                <span class="px-3 py-1 file-input-button" v-translate="'browse'"></span>
            </label>
        </div>
