            ...
            <div class="mt-2 static-custom-values">
                <form novalidate>
                    <div class="row p-0 mb-2">
                        ...
                        <p v-if="selectedScale.customMin" class="col col-form-label ps-0">{{ scaleText }}</p>
                    </div>
                    <div class="row">
                        ...
                        <p v-if="selectedScale.customMax" class="col col-form-label ps-0">{{ scaleText }}</p>
                    </div>
                </form>
            </div>
            <div class="text-danger mt-1 pe-1">{{ invalidMsg }}</div>
        </div>
    </div>
</template>
