<template>
    <div>
        ...
        <hr/>
        <warning-alert v-if="activeStep !== 3" :warnings="activeStepWarnings" :active-step="activeStep"></warning-alert>
        ...
        <template v-if="activeStep === 3">
            <warning-alert :warnings="activeStepWarnings" :active-step="activeStep"></warning-alert>
        </template>
