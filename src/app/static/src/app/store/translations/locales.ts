export interface Translations {
    ...
    load: string,
    loadError: string,
    loadErrorSteps: string,
    loadErrorStepsAllAction: string,
    loadErrorStepsFromValidAction: string,
    loadErrorStepsFromValidInfo: string,
...
const en: Translations = {
    ...
    loadErrorSteps: "There was a problem loading the following steps:",
    loadErrorStepsAllAction: "Retry load or rollback? Rollback will result in a loss of all project data.",
    loadErrorStepsFromValidAction: "Retry load or rollback to the last valid step, which is",
    loadErrorStepsFromValidInfo: "Rollback will be done in a new version - the current project version state will be preserved.",
...
const fr: Partial<Translations> = {
    ...
    loadErrorSteps: "Un problème est survenu lors du chargement des étapes suivantes:",
    loadErrorStepsAllAction: "Refaire ou revenir en arrière? Revenir en arrière entraînera la perte de toutes les données du projet.",
    loadErrorStepsFromValidAction: "Refaire ou revenir en arrière jusqu'au dernier étape valide, qui est",
    loadErrorStepsFromValidInfo: "Revenir en arrière sera effectuée dans une nouvelle version - l'état actuel de la version du projet sera conservé.",
...
const pt: Partial<Translations> = {
    ...
    loadErrorSteps: "Ocorreu um problema ao carregar as seguintes etapas:",
    loadErrorStepsAllAction: "Tentar carregar novamente ou reverter? Reverter resultará na perda de todos os dados do projeto.",
    loadErrorStepsFromValidAction: "Tente carregar novamente ou reverter para a última etapa válida, que é",
    loadErrorStepsFromValidInfo: "Reverter será feita em uma nova versão - o estado da versão atual do projeto será preservado.",
