...
const en: Translations = {
    ...
    loadOptionsError: "There was a problem loading your data. Please contact your workshop technical support and show them this code :",
    ...
    noMapData: "No data to display on map for these selections",
...
const fr: Partial<Translations> = {
    ...
    loadOptionsError: "Un problème est survenu lors du chargement de vos données. Veuillez contacter le support technique de votre atelier et leur montrer ce code :",
    ...
    noMapData : "Aucune donnée à afficher sur la carte pour ces sélections",
    ...
    renameProjectHistoryHeader: "Renommer",
