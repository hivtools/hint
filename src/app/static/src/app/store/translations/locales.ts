...
const fr: Partial<Translations> = {
    ...
    renameProjectHeader: "Entrez un nouveau nom pour le projet",
    ...
    select: "Sélectionner...",
    selectADR: "Sélectionnez l'ensemble de données ADR",
    ...
    uniqueProjectName: "Veuillez fournir un nom unique",
