export interface Translations {
    ...
    errorFetchingDatasetsFromADRNoAccount: string,
...
const en: Translations = {
    ...
    errorFetchingDatasetsFromADRNoAccount: "Cannot fetch datasets from the ADR as you do not yet have an account. Please login to the ADR with your Auth0 credentials and then return here and try again.",
...
const fr: Partial<Translations> = {
    ...
    errorFetchingDatasetsFromADRNoAccount: "Impossible d'obtenir des ensembles de données de l'EIM car vous n'avez pas encore de compte. Veuillez vous connecter à l'ADR avec vos identifiants Auth0, puis revenez ici et réessayez.",
...
const pt: Partial<Translations> = {
    ...
    errorFetchingDatasetsFromADRNoAccount: "Não é possível obter conjuntos de dados do ADR porque ainda não tem uma conta. Inicie sessão no ADR com as suas credenciais Auth0 e, em seguida, regresse aqui e tente novamente",
