...
const en: Translations = {
    ...
    inputTimeSeriesDescription: "Values are shown in red when they differ from the previous or subsequent value by more than 25%.",
...
const fr: Partial<Translations> = {
    ...
    inputTimeSeriesDescription: "Les valeurs sont affichées en rouge lorsqu'elles diffèrent de plus de 25 % de la valeur précédente ou suivante.",
...
const pt: Partial<Translations> = {
    ...
    inputTimeSeriesDescription: "Os valores são exibidos em vermelho quando diferem do valor anterior ou subsequente em mais de 25%.",
