...
const en: Translations = {
    ...
    custom: "Custom",
    datasetChangeWarning: "Changing the selected dataset will result in changes to all subsequent steps being discarded.",
    default: "Default",
    delete: "Delete",
...
const fr: Partial<Translations> = {
    ...
    custom: "Personnalisé",
    datasetChangeWarning: "La modification de l'ensemble de données sélectionné entraînera la suppression des modifications de toutes les étapes suivantes.",
    default: "Défaut",
    delete: "Supprimer",
