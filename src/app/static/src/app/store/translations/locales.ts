...
const en: Translations = {
    ...
    uploadDescToAdr: "Description (this will be appended to file metadata):",
    uploadInstruction: "Please select the new or modified files which should be uploaded",
    uploadModelToAdr: "Model outputs",
    uploadPopulationToAdr: "Population",
    uploadSurvey: "Upload survey and programme data",
    uploadSummaryToAdr: "Summary report",
    uploadToAdr: "Upload to ADR",
    username: "Username",
...
const fr: Partial<Translations> = {
    ...
    uploadDataset: "Base de données:",
    uploadDescToAdr: "Description (elle sera ajoutée aux métadonnées du fichier):",
    uploadInstruction: "Veuillez sélectionner les fichiers nouveaux ou modifiés qui doivent être téléchargés",
    uploadModelToAdr: "sorties du modèle",
    uploadPopulationToAdr: "Population",
    uploadSurvey: "Télécharger les données d'enquête et de programme",
    uploadSummaryToAdr: "Rapport sommaire",
    uploadToAdr: "Télécharger vers ADR",
