...
const fr: Partial<Translations> = {
    ...
    entireDataset: "entireDatasetFR",
    export: "Exporter",
    exportOutputs: "Exporter des sorties de modèles pour Spectrum",
    file: "Fichier",
    filteredDataset: "FilteredDatasetFR",
    filters: "Filtres",
    fitToCurrentDataset: "FitToCurrentFR",
    ...
    loggedInAs: "loggedInAsFR",
    logIn: "Ouvrir une session",
    logout: "Fermer une session",
    max: "maxFR",
    maxMustBeGreaterThanMin: "MaxMustFR",
    min: "minFR",
    map: "Carte",
