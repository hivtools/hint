...
const pt: Partial<Translations> = {
    ...
    resetTokenInvalid: "Esta ligação de reposição de palavra-passe não é válida. Pode ter expirado ou já ter sido utilizada.\n". +_x000D_ "Por favor, solicite outra ligação <a href=\"/password/forgot-password\">aqui</a>.",
    ...
    upload: "Carregar",
    uploading: "A carregar (isto pode demorar algum tempo)",
