export interface Translations {
    ...
    downloadSpectrumOrSummaryError: string,
...
const en: Translations = {
    ...
    area: "Area",
    ART: "ART",
    apiCouldNotParseError: "HTTP error {{statusCode}}, there was a problem processing your request. Please contact support.",
    ...
    downloadSpectrumOrSummaryError: "{{ outputFileType }} output file is not available for upload.",
...
const fr: Partial<Translations> = {
    ...
    apiCouldNotParseError: "Erreur HTTP {{statusCode}}, il y a eu un problème lors du traitement de votre demande. Veuillez contacter l'assistance.",
    ...
    downloadSpectrumOrSummaryError: "Le fichier de sortie {{ outputFileType }} n'est pas disponible pour le téléchargement",
...
const pt: Partial<Translations> = {
    ...
    area: "Área",
    ART: "TARV",
    apiCouldNotParseError: "Erro HTTP {{statusCode}}, ocorreu um problema ao processar sua solicitação. Entre em contato com o suporte.",
    ...
    downloadSpectrumOrSummaryError: "O arquivo de saída do {{ outputFileType }} não está disponível para upload",
