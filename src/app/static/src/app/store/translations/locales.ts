...
const en: Translations = {
    ...
    privacyLengthList: "<li>We will only retain your personal data for as long as necessary to fulfil the purposes we collected it for, including for the purposes of satisfying any legal, accounting, or reporting requirements.</li>" +
        "               <li>We therefore will remove your data when the site is discontinued or when you request we do so.</li>",
