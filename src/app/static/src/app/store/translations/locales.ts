...
const en: Translations = {
    ...
    errorReportError: "An error occurred while sending your report:",
    errorReportSuccess: "Thank you, your report has been sent. We will respond as soon as possible.",
    export: "Export",
...
const fr: Partial<Translations> = {
    ...
    errorReportError: "Une erreur s'est produite lors de l'envoi de votre rapport :",
    errorReportSuccess: "Merci, votre rapport a été envoyé. Nous vous répondrons dans les plus brefs délais.",
    export: "Exporter",
...
const pt: Partial<Translations> = {
    ...
    errorReportError: "Ocorreu um erro ao enviar seu relatório:",
    errorFetchingDatasetsFromADR: "Ocorreu um erro ao obter conjuntos de dados do ADR",
    errorReportSuccess: "Obrigado, seu relatório foi enviado. Nós responderemos o mais rapidamente possível.",
    export: "Exportação",
