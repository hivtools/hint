...
export type Translations = {
    ...
    custom: string,
    DatapackDownload: string,
    datasets: string,
    datasetsWithOutputZip: string,
    ...
    errorWhileGeneratingDownload: string,
    export: string,
    faq: string,
    female: string,
    file: string,
    ...
    inputComparisonBarchart: string,
    inputComparisonTooltipDifferenceNaomi: string,
    inputComparisonTooltipDifferenceSpectrum: string,
    inputComparisonTable: string,
    import: string,
    ...
    spectrum: string,
    spectrumReallocation: string,
    spectrumAdjustmentRatio: string,
    spectrum_adjusted: string,
    spectrum_reported: string,
    static: string,
    step: string,
    support: string,
    survey: string,
    table: string,
    tableArtTooltipdifference: string,
    tableArtTooltipdifference_ratio: string,
    timeSeries: string,
...
const en: Translations = {
    ...
    adrImportOutput: "Import output ZIP from ADR",
    adrRead: "Read only",
    ...
    custom: "Custom",
    DatapackDownload: "PEPFAR Target Setting Tool (TST) outputs",
    datasets: "Datasets",
    datasetsWithOutputZip: "Datasets with a Naomi output zip",
    ...
    CoarseOutputDownload: "Coarse age group outputs",
    downloadIndicator: "Download data",
    ...
    errorWhileGeneratingDownload: "Error while generating",
    export: "Export",
    SpectrumDownload: "Naomi results",
    faq: "FAQ",
    female: "Female",
    file: "File",
    ...
    inputComparisonBarchart: "Comparison barchart",
    inputComparisonTooltipDifferenceNaomi: "Difference from Spectrum: {{ difference }}",
    inputComparisonTooltipDifferenceSpectrum: "Difference from Naomi: {{ difference }}",
    inputComparisonTable: "Comparison table",
    import: "Import",
    ...
    populationPlotNote: "The colored bars represent age and sex specific population as a proportion of total population. The black lines represent the national age and sex specific proportions for comparison.",
    ...
    releases: "Releases",
    releasesWithOutputZip: "Releases with a Naomi output zip",
    ...
    required: "required",
    resetSingleFilter: "Reset filter",
    ...
    spectrum: "Spectrum",
    spectrumReallocation: "Spectrum rellocation:",
    spectrumAdjustmentRatio: "Naomi:Spectrum adjustment ratio:",
    spectrum_adjusted: "Spectrum adjusted",
    spectrum_reported: "Spectrum reported",
    static: "Static",
    step: "Step",
    support: "Online support",
    survey: "Household survey",
    table: "Table",
    tableArtTooltipdifference: "Naomi - Spectrum adjusted",
    tableArtTooltipdifference_ratio: "1 - (Naomi - Spectrum adjusted) / Spectrum adjusted",
    ...
    upload: "Upload",
    uploadFromZip: "Loading project from output zip",
    uploading: "Uploading...",
...
const fr: Partial<Translations> = {
    ...
    DatapackDownload: "Les sorties pour PEPFAR Target Setting Tool (TST)",
    datasetsWithOutputZip: "Ensembles de données avec un zip de sortie Naomi",
    ...
    difference_ratio: "Rapport de différence",
    ...
    CoarseOutputDownload: "Les résultats grossiers du groupe d'âge",
    downloadIndicator: "Télécharger les données",
    ...
    errorWhileGeneratingDownload: "Erreur lors de la génération",
    export: "Exporter",
    SpectrumDownload: "Les résultats de Naomi",
    faq: "FAQ",
    female: "Femelle",
    file: "Fichier",
    ...
    inputComparisonBarchart: "Graphique de comparaison",
    inputComparisonTooltipDifferenceNaomi: "Différence avec le Spectrum: {{ difference }}",
    inputComparisonTooltipDifferenceSpectrum: "Différence avec le Naomi: {{ difference }}",
    inputComparisonTable: "Tableau de comparaison",
    import: "Importer",
    ...
    population: "Population",
    populationPlotNote: "Les barres colorées représentent la population par âge et par sexe en proportion de la population totale. Les lignes noires représentent les proportions nationales spécifiques à l’âge et au sexe à des fins de comparaison.",
    ...
    releases: "Versions",
    releasesWithOutputZip: "Versions avec un zip de sortie Naomi",
    ...
    resetSingleFilter: "Réinitialiser filtre",
    ...
    spectrum: "Spectrum",
    spectrumReallocation: "Relocalisation du Spectrum:",
    spectrumAdjustmentRatio: "Naomi:Rapport d'ajustement du Spectrum:",
    spectrum_adjusted: "Spectrum ajusté",
    spectrum_reported: "Spectrum rapporté",
    static: "Statique",
    step: "Étape",
    support: "Support en ligne",
    survey: "Enquête de ménage",
    table: "Tableau",
    tableArtTooltipdifference: "Naomi - Spectrum ajusté",
    tableArtTooltipdifference_ratio: "1 - (Naomi - Spectrum ajusté) / Spectrum ajusté",
...
const pt: Partial<Translations> = {
    ...
    DatapackDownload: "Resultados para PEPFAR Target Setting Tool (TST)",
    datasetsWithOutputZip: "Conjuntos de dados com um zip de saída Naomi",
    ...
    difference_ratio: "Rácio de diferença",
    ...
    CoarseOutputDownload: "Resultados de grupos etários grosseiros",
    downloadIndicator: "Descarregar dados",
    ...
    ComparisonDownload: "Relatório de comparação",
    ...
    SummaryDownload: "Relatório de síntese",
    ...
    errorWhileGeneratingDownload: "Erro ao gerar",
    export: "Exportação",
    SpectrumDownload: "Resultados de Naomi",
    ...
    inputComparisonBarchart: "Gráfico de comparação",
    inputComparisonTooltipDifferenceNaomi: "Diferença em relação ao Spectrum: {{ difference }}",
    inputComparisonTooltipDifferenceSpectrum: "Diferença em relação ao Naomi: {{ difference }}",
    inputComparisonTable: "Tabela de comparação",
    import: "Importação",
    ...
    populationPlotNote: "As barras coloridas representam a população específica por idade e sexo como proporção da população total. As linhas pretas representam as proporções nacionais específicas de idade e sexo para comparação.",
    ...
    releasesWithOutputZip: "Lançamentos com um zip de saída Naomi",
    ...
    required: "necessário",
    resetSingleFilter: "Redefinir filtro",
    ...
    spectrum: "Spectrum",
    spectrumReallocation: "Deslocação do Spectrum:",
    spectrumAdjustmentRatio: "Naomi: rácio de ajustamento do Spectrum:",
    spectrum_adjusted: "Spectrum ajustado",
    spectrum_reported: "Spectrum reportado",
    static: "Estático",
    step: "Etapa",
    support: "Apoio online",
    survey: "Inquérito aos agregados familiares",
    table: "Tabela",
    tableArtTooltipdifference: "Naomi - Spectrum ajustado",
    tableArtTooltipdifference_ratio: "1 - (Naomi - Spectrum ajustado) / Spectrum ajustado",
