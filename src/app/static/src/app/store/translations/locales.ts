export interface Translations {
    ...
    or: string,
    optionsValid: string,
    outputFileART: string
    outputFileDataset: string,
    outputFileDesc: string,
    outputFileInstruction: string,
    outputFileModeloutputs: string,
    outputFilePopulation: string,
    outputFileOverwrite: string,
    outputFileSummary: string,
    outputFileToAdr: string,
    password: string,
...
const en: Translations = {
    ...
    outputFileART: "ART",
    outputFileDataset: "Dataset:",
    outputFileDesc: "Description (this will be appended to file metadata):",
    outputFileInstruction: "Please select the new or modified files which should be uploaded",
    outputFileModeloutputs: "Model outputs",
    outputFilePopulation: "Population",
    outputFileOverwrite: "This file already exists on ADR and will be overwritten. File was updated ",
    outputFileSummary: "Summary report",
    outputFileToAdr: "Upload to ADR",
    password: "Password",
...
const fr: Partial<Translations> = {
    ...
    outputFileToAdr: "Télécharger vers ADR",
