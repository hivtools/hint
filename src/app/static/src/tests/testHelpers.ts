...
export function expectTranslatedWithStoreType<T extends TranslatableState>(element: VueWrapper<any>,
                                                                           englishText: string,
                                                                           frenchText: string,
...
export const expectTranslated = (element: VueWrapper<any>,
                                 englishText: string,
                                 frenchText: string,
                                 portugueseText: string,
...
export const expectErrorReportOpen = (wrapper: VueWrapper<any>, row = 0) => {
