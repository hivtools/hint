        ...
        modules: {
            ...
            modelOutput: {
                ...
                getters: {
                    ...
                    countryAreaFilterOption: jest.fn().mockReturnValue(["TEST countryAreaFilterOption"]),
                    ...partialGetters
                },
...
describe("ModelOutput component", () => {
    ...
    it("renders choropleth table", () => {
        ...
        expect(table.props().countryAreaFilterOption).toStrictEqual(["TEST countryAreaFilterOption"]);
    });
