...
import {initialDownloadResults} from "../../src/store/downloadResults/downloadResults";
import {Warning} from "../../src/generated";
import {extractErrors, nowTime} from "../../src/utils";
...
describe("root getters", () => {
    ...
    const reviewInputWarnings: Warning[] = [
    ...
    const testState = () => {
        return mockRootState({
            ...
            reviewInput: mockReviewInputState({warnings: reviewInputWarnings}),
    ...
    it(`can get warnings when on review inputs step`, () => {
        ...
        expect(result).toEqual([
            ...
            {locations: ["review_inputs"], text: "review input test"}])
    })
    ...
    it(`can get empty warnings when all warnings properties are undefined in state`, () => {
        ...
        const rootState = mockRootState({
            ...
            reviewInput: mockReviewInputState({warnings: undefined}),
    ...
    it(`can get reviewInput, survey and program warnings if exists in review inputs step`, () => {
        const rootState = testState()
    ...
    it(`can get serialized project states`, () => {
        ...
        const updated = `2022/06/19 13:56:19`
    ...
    it(`can get serialized project states when logged in as guest`, () => {
        ...
        const updated = `${year}/${month}/${day} ${hour}:${minute}:${second}`;
