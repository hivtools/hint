...
import {actions} from "../../../src/store/modelRun/actions";
import {mutations} from "../../../src/store/modelRun/mutations";
import {modelRunGetters, ModelRunState} from "../../../src/store/modelRun/modelRun";
import {getters as stepperGetters} from "../../../src/store/stepper/getters";
import {getters as rootGetters} from "../../../src/store/root/getters";
import {emptyState, RootState} from "../../../src/root";
import ModelRun from "../../../src/components/modelRun/ModelRun.vue";
import Modal from "../../../src/components/Modal.vue";
import Tick from "../../../src/components/Tick.vue";
...
describe("Model run component", () => {
    ...
    it("displays message and tick if step is complete", () => {
        ...
        expect(wrapper.find("#model-run-complete").classes()).toStrictEqual(["mt-3", "d-flex", "align-items-center", "me-2"]);
