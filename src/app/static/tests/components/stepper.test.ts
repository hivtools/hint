...
import {baselineGetters, BaselineState} from "../../src/store/baseline/baseline";
import {
    mockADRState,
    mockBaselineState,
...
import {SurveyAndProgramState} from "../../src/store/surveyAndProgram/surveyAndProgram";
import {getters as surveyAndProgramGetters} from "../../src/store/surveyAndProgram/getters";
import {mutations} from '../../src/store/baseline/mutations';
import {mutations as surveyAndProgramMutations} from '../../src/store/surveyAndProgram/mutations';
import {ModelRunMutation, mutations as modelRunMutations} from '../../src/store/modelRun/mutations';
import {mutations as stepperMutations} from '../../src/store/stepper/mutations';
import {mutations as loadMutations} from '../../src/store/load/mutations';
import {ModelCalibrateMutation, mutations as modelCalibrateMutations} from '../../src/store/modelCalibrate/mutations';
import {modelRunGetters, ModelRunState} from "../../src/store/modelRun/modelRun";
import ADRIntegration from "../../src/components/adr/ADRIntegration.vue";
import Stepper from "../../src/components/Stepper.vue";
import Step from "../../src/components/Step.vue";
import LoadingSpinner from "../../src/components/LoadingSpinner.vue";
import {actions} from "../../src/store/stepper/actions";
import {getters} from "../../src/store/stepper/getters";
import {StepperState} from "../../src/store/stepper/stepper";
import {actions as rootActions} from "../../src/store/root/actions"
import {mutations as rootMutations} from "../../src/store/root/mutations"
import {MetadataState} from "../../src/store/metadata/metadata";
import {ModelStatusResponse, Warning} from "../../src/generated";
import {modelOptionsGetters, ModelOptionsState} from "../../src/store/modelOptions/modelOptions";
import {LoadingState, LoadState} from "../../src/store/load/state";
...
import {ModelCalibrateState} from "../../src/store/modelCalibrate/modelCalibrate";
import VersionStatus from "../../src/components/projects/VersionStatus.vue";
import {RootState} from "../../src/root";
import ModelCalibrate from "../../src/components/modelCalibrate/ModelCalibrate.vue";
import {getters as rootGetters} from "../../src/store/root/getters";
...
import WarningAlert from "../../src/components/WarningAlert.vue";
import LoadInvalidModal from "../../src/components/load/LoadInvalidModal.vue";
import {ModelOptionsMutation} from "../../src/store/modelOptions/mutations";
import {ReviewInputState} from "../../src/store/reviewInput/reviewInput";
import {ReviewInputMutation} from "../../src/store/reviewInput/mutations";
...
describe("Stepper component", () => {
    ...
    it("updates from completed state when active step data is populated", async () => {
        ...
        //invoke the mutation
        (wrapper.vm as any).$store.commit("baseline/Validated", {
            "type": "Validated",
    ...
    async function makeReady(wrapper: any) {
        ...
        (wrapper.vm as any).$store.commit("surveyAndProgram/Ready", {
            "type": "Ready",
            "payload": true
        });

        (wrapper.vm as any).$store.commit("modelCalibrate/Ready", {
            "type": "Ready",
            "payload": true
        });
    ...
    async function makeLoading(wrapper: any) {
        ...
        (wrapper.vm as any).$store.commit("load/SettingFiles", {
            "type": "SettingFiles",
            "payload": null
        });
    ...
    const testModelRunCompletion = async (modelRunWarnings: Warning[], expectAdvanceToCalibrate: boolean)=> {
        ...
        (wrapper.vm as any).$store.commit("modelRun/RunStatusUpdated", {
        ...
        (wrapper.vm as any).$store.commit("modelRun/WarningsFetched", {
            type: "WarningsFetched",
            payload: modelRunWarnings
        });

        (wrapper.vm as any).$store.commit("modelRun/RunResultFetched", {
