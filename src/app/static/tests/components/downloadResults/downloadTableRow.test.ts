...
import { DownloadType, fileTypeUIConfigs, statusUIConfigs, TaskStatus } from "../../../src/store/downloadResults/downloadConfig";
import { DownloadResultsDependency } from "../../../src/types";
