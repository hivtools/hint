import ProjectHistory from "../../../src/components/projects/ProjectHistory.vue";
...
import ShareProject from "../../../src/components/projects/ShareProject.vue";
...
describe("Project history component", () => {
    ...
    const testRendersProject = async (wrapper: any, id: number, name: string, updatedIsoDate: string,
        ...
        await expectTranslated(v[2], versionCountLabel, versionCountLabel, ptVersionCountLabel, (wrapper.vm as any).$store);
    ...
    it('can render shared by email when project is shared', async () => {
        ...
        (wrapper.vm as any).$store.state.language = Language.fr;
        await nextTick();
