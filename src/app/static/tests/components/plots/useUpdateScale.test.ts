...
import {useUpdateScale} from "../../../src/components/plots/useUpdateScale";
import {Scale, ScaleSettings, ScaleType} from "../../../src/store/plotState/plotState";
...
describe('useUpdateScale', () => {
    ...
    vi.mock('../../../src/components/plots/utils', () => ({
