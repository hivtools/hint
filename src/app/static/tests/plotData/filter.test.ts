...
} from "../../src/store/plotData/filter";
import {PlotDataMutations, PlotDataUpdate} from "../../src/store/plotData/mutations";
import {PlotSelectionsMutations, PlotSelectionUpdate} from "../../src/store/plotSelections/mutations";
...
import {FilterSelection} from "../../src/store/plotSelections/plotSelections";
...
describe("filter tests", () => {
    ...
    describe("getOutputFilteredData works as expected", () => {
        ...
        it("commits error if fetch fails", async () => {
            ...
            expect(commit.mock.calls.length).toBe(1);
            expect(commit.mock.calls[0][0].type).toStrictEqual(`plotSelections/${PlotSelectionsMutations.setError}`);
            expect(commit.mock.calls[0][1].root).toStrictEqual(true);
        });
    });
