import {storeOptions} from "../src/root";
...
import {beforeEnter, router} from '../src/router';
...
vi.mock("../src/components/Stepper.vue", () => ({
    default: {
        name: "Stepper",
...
vi.mock("../src/components/projects/Projects.vue", () => ({
    default: {
        name: "Projects",
